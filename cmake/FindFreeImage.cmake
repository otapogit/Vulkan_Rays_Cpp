...
if (WIN32)
  find_file(FreeImage_DLL_LIBRARY
	...
	find_library(FreeImage_STATIC_LIBRARY_DEBUG
	  NAMES
		${CMAKE_STATIC_LIBRARY_PREFIX}FreeImageLIBd${CMAKE_STATIC_LIBRARY_SUFFIX}
		${CMAKE_STATIC_LIBRARY_PREFIX}FreeImaged${CMAKE_STATIC_LIBRARY_SUFFIX}
		${CMAKE_STATIC_LIBRARY_PREFIX}freeimaged${CMAKE_STATIC_LIBRARY_SUFFIX}
	  PATHS
		${FreeImage_ROOT}
	  DOC "The FreeImage debug static library")
endif ()
